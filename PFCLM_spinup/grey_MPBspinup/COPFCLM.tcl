...
set runname CO.2008.grey.pfclm
...
pfset TimingInfo.StopTime                       8784       	
...
#### istep used for intiial and restarts of CLM-- restart
## set to PF StartCount + 1
set istep 1
if { $istep > 1 } then {

 for { set i 0 } { $i < $nproc } { incr i 1 } {
        set fname_rst [format "clm.rst.%05d.$i" [expr $istep-1]]
...
pfdist press.in.20081001.SP2grey.pfb
...
pfset Solver.CLM.MetFilePath                          /glade/scratch/mforrest/Thesis/PFCLM/NLDAS_forcing/WY2008 
pfset Solver.CLM.MetFileNT                            12

## test - restart
#pfset Solver.CLM.IstepStart                         1 
#pfset Solver.CLM.IstepStart                        283 
#  set this to synch with the istep variable used
# to copy CLM restart files above
#
...
pfset Geom.domain.ICPressure.FileName                   press.in.20081001.SP2grey.pfb
