...
pfset TimingInfo.BaseUnit			0.001666666666666666666 ;# Must match the timestep unit for WRF! 4 s =4* 1/3600 hr
pfset TimingInfo.StartCount			0.0
pfset TimingInfo.StartTime			0.0
pfset TimingInfo.StopTime       	        1000000
pfset TimingInfo.DumpInterval   	        -4 ;# We want it to dump out every hour = every 4 times PF is called
pfset TimeStep.Type			    	Constant
pfset TimeStep.Value				150 ;#Should be set by WRF, but set here also just in case
